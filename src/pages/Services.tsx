...
export default function Services() {
  ...
  const eauImage = "https://storage.googleapis.com/krbengineering/Final%20update/1.jpg";
  ...
  const energieImage = "https://storage.googleapis.com/krbengineering/Final%20update/BILD0047.JPG";
